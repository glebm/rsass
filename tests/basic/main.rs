...
/// From "sass-spec/spec/basic/01_simple_css"
#[test]
fn t01_simple_css() {
    assert_eq!(
        rsass("a {\n  color: blue;\n}").unwrap(),
...
/// From "sass-spec/spec/basic/02_simple_nesting"
#[test]
...
/// From "sass-spec/spec/basic/03_simple_variable"
#[test]
...
/// From "sass-spec/spec/basic/04_basic_variables"
#[test]
...
/// From "sass-spec/spec/basic/05_empty_levels"
#[test]
fn t05_empty_levels() {
    assert_eq!(
        rsass(
...
/// From "sass-spec/spec/basic/06_nesting_and_comments"
#[test]
...
/// From "sass-spec/spec/basic/07_nested_simple_selector_groups"
#[test]
...
/// From "sass-spec/spec/basic/08_selector_combinators"
#[test]
...
/// From "sass-spec/spec/basic/09_selector_groups_and_combinators"
#[test]
...
/// From "sass-spec/spec/basic/10_classes_and_ids"
#[test]
...
/// From "sass-spec/spec/basic/11_attribute_selectors"
#[test]
...
/// From "sass-spec/spec/basic/12_pseudo_classes_and_elements"
#[test]
...
/// From "sass-spec/spec/basic/13_back_references"
#[test]
...
/// From "sass-spec/spec/basic/18_mixin_scope"
#[test]
fn t18_mixin_scope() {
    assert_eq!(
        rsass(
...
/// From "sass-spec/spec/basic/19_full_mixin_craziness"
#[test]
...
/// From "sass-spec/spec/basic/20_scoped_variables"
#[test]
...
/// From "sass-spec/spec/basic/21_one_builtin_function"
#[test]
...
/// From "sass-spec/spec/basic/22_colors_with_alpha"
#[test]
...
/// From "sass-spec/spec/basic/25_basic_string_interpolation"
#[test]
...
/// From "sass-spec/spec/basic/26_selector_interpolation"
#[test]
...
/// From "sass-spec/spec/basic/27_media_queries"
#[test]
...
/// From "sass-spec/spec/basic/28_url"
#[test]
fn t28_url() {
    assert_eq!(
        rsass(
...
/// From "sass-spec/spec/basic/29_if"
#[test]
fn t29_if() {
    assert_eq!(
        rsass(
...
/// From "sass-spec/spec/basic/30_if_in_function"
#[test]
...
/// From "sass-spec/spec/basic/31_if_in_mixin"
#[test]
fn t31_if_in_mixin() {
    assert_eq!(
        rsass(
...
/// From "sass-spec/spec/basic/32_percentages"
#[test]
fn t32_percentages() {
    assert_eq!(
        rsass(
...
/// From "sass-spec/spec/basic/36_extra_commas_in_selectors"
#[test]
...
/// From "sass-spec/spec/basic/37_url_expressions"
#[test]
...
/// From "sass-spec/spec/basic/38_expressions_in_at_directives"
#[test]
...
/// From "sass-spec/spec/basic/39_dash_match_attribute_selector"
#[test]
fn t39_dash_match_attribute_selector() {
    assert_eq!(
        rsass("div[class|=\"blah\"] {\n  color: blue;\n}").unwrap(),
        "div[class|=\"blah\"] {\n  color: blue;\n}\n"
    );
}

/// From "sass-spec/spec/basic/40_pseudo_class_identifier_starting_with_n"
#[test]
...
/// From "sass-spec/spec/basic/41_slashy_urls"
#[test]
fn t41_slashy_urls() {
    assert_eq!(
        rsass(
...
/// From "sass-spec/spec/basic/42_css_imports"
#[test]
fn t42_css_imports() {
    assert_eq!(
        rsass(
...
/// From "sass-spec/spec/basic/44_bem_selectors"
#[test]
...
/// From "sass-spec/spec/basic/48_case_conversion"
#[test]
...
/// From "sass-spec/spec/basic/49_interpolants_in_css_imports"
#[test]
...
/// From "sass-spec/spec/basic/50_wrapped_pseudo_selectors"
#[test]
...
/// From "sass-spec/spec/basic/51_trailing_commas_in_list"
#[test]
...
/// From "sass-spec/spec/basic/52_interchangeable_hyphens_underscores"
#[test]
...
/// From "sass-spec/spec/basic/55_variable_exists"
#[test]
...
/// From "sass-spec/spec/basic/56_global_variable_exists"
#[test]
...
/// From "sass-spec/spec/basic/57_function_exists"
#[test]
...
/// From "sass-spec/spec/basic/58_mixin_exists"
#[test]
fn t58_mixin_exists() {
    assert_eq!(
        rsass(
...
/// From "sass-spec/spec/basic/59_if_expression"
#[test]
...
/// From "sass-spec/spec/basic/60_call"
#[test]
fn t60_call() {
    assert_eq!(
        rsass(
